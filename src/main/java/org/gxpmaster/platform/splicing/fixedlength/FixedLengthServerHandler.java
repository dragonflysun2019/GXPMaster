...
public class FixedLengthServerHandler extends ChannelInboundHandlerAdapter {
    ...
    static private final Logger LOGGER = LoggerFactory.getLogger(FixedLengthServerHandler.class);
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        ctx.writeAndFlush(Unpooled.copiedBuffer(Unpooled.copiedBuffer(FixedLengthServer.RESPONSE.getBytes())));
    }
